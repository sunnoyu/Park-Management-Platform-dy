                        ...
                        <Card className="mt">
                            <Card title="待办事项" extra={<a href="#">更多&gt;</a>} >
                                <div style={{ display: "flex", justifyContent: "space-between", lineHeight: "30px" }}>
                                    ...
                                    <span style={{ color: "#666" }}>2025-01-02</span>
                                </div>
                                <div style={{ display: "flex", justifyContent: "space-between", lineHeight: "30px" }}>
                                    <Badge color="blue" text="充电桩维修报修" />
                                    <span style={{ color: "#666" }}>2025-03-12</span>
                                </div>
                                <div style={{ display: "flex", justifyContent: "space-between", lineHeight: "30px" }}>
                                    <Badge color="blue" text="空调使用费统一征收" />
                                    <span style={{ color: "#666" }}>2025-03-22</span>
                                </div>
                                <div style={{ display: "flex", justifyContent: "space-between", lineHeight: "30px" }}>
                                    <Badge color="gray" text="租户物业费催缴" />
                                    <span style={{ color: "#666" }}>2025-04-01</span>
                                </div>
                                <div style={{ display: "flex", justifyContent: "space-between", lineHeight: "30px" }}>
                                    <Badge color="gray" text="潜在意向客户跟访" />
                                    <span style={{ color: "#666" }}>2025-04-07</span>
                                </div>
                                <div style={{ display: "flex", justifyContent: "space-between", lineHeight: "30px" }}>
                                    <Badge color="gray" text="园区保洁注意事项" />
                                    <span style={{ color: "#666" }}>2025-05-02</span>
                                </div>
                            </Card>
                        </Card>
                    </Col>
